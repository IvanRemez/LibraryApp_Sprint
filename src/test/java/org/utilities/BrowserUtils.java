...
public class BrowserUtils {
    ...
    public static boolean isValid(String urlString) {
        ...
        Response response = RestAssured.get(urlString);
    ...
    public static void checkLinks(String tag) {
        ...
        List<WebElement> allLinks = Driver.get().findElements(By.tagName(tag));
        System.out.println("For this  module link counts are "+allLinks.size());

        for (WebElement eachLink : allLinks) {
            System.out.println(eachLink.getAttribute("href") + " is valid " + isValid(eachLink.getAttribute("href")));
            Assert.assertTrue(isValid(eachLink.getAttribute("href")));
        }
    }

    public static void checkImages(String tag) {

        List<WebElement> allImages = Driver.get().findElements(By.tagName(tag));
        System.out.println("For this  module image counts are " + allImages.size());

        for (WebElement eachImage : allImages) {
            System.out.println(eachImage.getAttribute("src") + " is valid " + isValid(eachImage.getAttribute("src")));
            Assert.assertTrue(isValid(eachImage.getAttribute("href")));
